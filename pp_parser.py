...
#Словари для принта в эксель
    ...
    for cli_full_final, cli_phone, urls_bbs, cost, ToC, address, status, DoC in zip(cli_full_final, cli_phone, urls_bbs, cost, ToC, address, status, DoC):
        flatten = cli_full_final, cli_phone, urls_bbs, cost, ToC, address, status, DoC
